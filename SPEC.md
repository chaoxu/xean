...
New artifacts use SQLite schema 8. Older schemas remain immutable historical artifacts and require their matching runtime. Opening an older artifact does not migrate it.
...
storePiResult(campaign, result): z.output<typeof piResultRecord> // from elenx/pi
readPiResult(output, reader): PiResult // from elenx/pi
