# xean core specification 1.0.0

This file is the normative contract for xean 1.0.0.
...
xean 1.0.0 campaigns use SQLite schema 1. The declaration records the schema and application identity, and a reader rejects an artifact whose schema is not the current one.
