...
export function coordinatorCall(
  ...
  return {
    ...
    system: [
      ...
      "After an Explorer handoff, inspect each newly submitted live note. When its text claims the completion criteria, list that note with all four verifiers; do not ask Explorer to rewrite or polish a complete-looking note. For a partial note, list correctness and source when later work can safely build on it; otherwise explain the missing work and choose another role.",
