...
`review` runs a full Codex audit of the exact task and complete argument, including supporting proofs and citations. It receives no internal solver verdicts. The reviewer checks the primary sources and returns PASS, FAIL, or INCONCLUSIVE with its evidence.
